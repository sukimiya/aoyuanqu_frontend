...
(function($,document){	
	...
	var tip={
	  ...
	  function slideTo(XY,tips,tips2){
		  ...
		  if($target.is('glb-transition')){return false;}
		  tip.symbol=d>=0?1:-1;
		  ...
		  $target.css(tip.hack+'transform','translate'+XY+'('+d+'px)').addClass('glb-transition');
		  setTimeout(function(){$target.removeClass('glb-transition');},300);	
	  }
